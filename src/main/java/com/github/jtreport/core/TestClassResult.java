...
public class TestClassResult {
    ...
    public TestClassResult(final String testPlan, final String testDesign, final String testScenario, final String testSummary, final String testClassName ) {
        this.testPlan=testPlan;
        this.tesDesign=testDesign;
