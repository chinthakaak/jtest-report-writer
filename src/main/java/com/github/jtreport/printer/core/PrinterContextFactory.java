...
import com.github.jtreport.printer.pdf.PrinterPdfTestCaseStrategy;
	...
	public PrinterContext createPrinter(final ReportTypePrinterEnum printerType, boolean margeReport) {
		...
		switch (printerType) {
			...
			case PDF :
				...
				break;
            case PDFTC :
                L.debug("PDFTC printer selected why reportType: [" + printerType.name() + "]");
                PrinterPdfTestCaseStrategy printerPdfTestCaseStrategy = new PrinterPdfTestCaseStrategy();
                printerPdfTestCaseStrategy.setMargeReport(margeReport);
                resultPrinterContext.setPrinterStrategy(printerPdfTestCaseStrategy);
                break;
			case XML :
