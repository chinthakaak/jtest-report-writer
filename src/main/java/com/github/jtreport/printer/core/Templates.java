...
//    public static final StyleBuilder normal5CenteredStyle;
	...
	static {
		...
		boldCenteredStyle = stl.style().setAlignment(HorizontalAlignment.CENTER, VerticalAlignment.MIDDLE).setPadding(2);
		bold12CenteredStyle = stl.style(boldCenteredStyle).setFontSize(8);
		...
		columnStyle = stl.style(bold12CenteredStyle).setHorizontalAlignment(HorizontalAlignment.LEFT)
    ...
    public static ComponentBuilder<?, ?> createSubTitleTestCaseResult(final TestClassResult testClassResult,
                                                                  final int totalRun) {

        HyperLinkBuilder link = hyperLink("https://www.google.lk");
        return cmp.verticalList(cmp.horizontalList(cmp.text("Class: ").setStyle(boldStyle).setHorizontalAlignment(HorizontalAlignment.LEFT).setFixedWidth(80),
                        cmp.text(testClassResult.getTestClassName()).setHorizontalAlignment(HorizontalAlignment.LEFT)),
                cmp.horizontalList(cmp.text("Summary: ").setStyle(boldStyle).setHorizontalAlignment(HorizontalAlignment.LEFT).setFixedWidth(80),
                        cmp.text(testClassResult.getTestSummary()).setHorizontalAlignment(HorizontalAlignment.LEFT).setHyperLink(link)),
                cmp.verticalGap(10));
    }
